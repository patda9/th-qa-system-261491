...
if(__name__ == '__main__'):
    ...
    # with open('./result/find_documents_output_test.json', 'w', errors='ignore') as find_doc:
    ...
    with open('./result/find_documents_output_test.json', 'r') as ids:
    ...
    #                     rr_score.append(fa.find_answer_word(i,j,j['answer_begin_position '],s,possible_answer,question_word_index,question,doc_id,answer_position))
    #                 elif l == 0:
    #                     for k in range(j['sentence'].__len__()):
    #                         if fa.hasNumbers(j['sentence'][k],thai_number_text):
    #                             doc_id[-1][-1].append(k)
    ...
    # # santipong.thaipryoon@nectec.or.th
