...
def locate_plain_text_characters(m_word_sentence_ranges, min_distance_indexes, original_tokens_ranges):
    ...
    return plain_text_character_positions
...
def locate_candidates_sentence(embedded_questions, embedded_sentences, m_word_sentence_ranges, 
    ...
    plaint_text_character_positions = locate_plain_text_characters(m_word_sentence_ranges, min_distance_indexes, original_tokens_ranges)

    return plaint_text_character_positions, min_distance_matrix
